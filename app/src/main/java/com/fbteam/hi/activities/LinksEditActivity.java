...
public class LinksEditActivity extends ActivityNavMenu implements View.OnClickListener {
    ...
    private void findElements(){
        ...
        links.setAdapter(new CategoryListAdapter(this, R.layout.edit_category_row));
